            ...
            try
            {
                ...
                for (int x = 0; x < _boardScriptableObject.XSize; x++)
                {
                    for (int y = 0; y < _boardScriptableObject.YSize; y++)
                    {
                        ...
                        _currentBlock.transform.DOScale(0.35f, 0.1f);
                        _boardScriptableObject.Blocks[x, y] = _currentBlock;
                    ...
                    while (y > 0)
                    {
                        if (_boardScriptableObject.Blocks[x, yBelow] == null)
                        {
                            if (yBelow == 0)
                            {
                                ...
                                {
                                    _boardScriptableObject.Obstacles[x, y].transform.DOMove(_boardScriptableObject.Tiles[x, yBelow].transform.position, 0.35f);
                                ...
                                _currentBlock.transform.DOMove(_boardScriptableObject.Tiles[x, yBelow].transform.position, 0.35f);
                        ...
                        else
                        {
                            if (_boardScriptableObject.Obstacles[x, y] != null && _boardScriptableObject.Obstacles[x, y].Type == ObstacleType.Rock)
                            {
                                _boardScriptableObject.Obstacles[x, y].transform.DOMove(_boardScriptableObject.Tiles[x, yBelow + 1].transform.position, 0.35f);
                            ...
                            _currentBlock.transform.DOMove(_boardScriptableObject.Tiles[x, yBelow + 1].transform.position, 0.35f);
